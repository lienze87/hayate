  ...
  <div class="main-content">
    ...
    <div class="content-container">
      <div class="video-container">
        <video crossorigin="anonymous" width="960" controls preload="metadata">
        ...
        <div class="video-part-list">
          <div v-for="item in dataList" :key="item.uuid" class="video-part-item">
            ...
            <div class="part-item-action">
              <el-button type="primary" @click="handlePreviewData(item)"> 预览 </el-button>
              <el-button type="primary" plain @click="handleEditData(item)"> 修改 </el-button>
              <el-button type="primary" plain @click="handleExtractData(item)"> 帧生成 </el-button>
            </div>
          </div>
        </div>
      </div>
    </div>
    <el-dialog v-model="partDialogVisible" title="数据更新" width="672" destroy-on-close>
        ...
        <div class="dialog-form">
          <el-form :model="editPartVideoData" label-width="120px">
            ...
            <el-form-item label="帧数">
              <el-input-number v-model="editPartVideoData.frames" :min="0" :max="9999" :step="1"></el-input-number>
            </el-form-item>
        ...
        <div class="dialog-form">
          <el-form :inline="true" :model="imageData" class="form-inline">
            <el-form-item label="起始帧">
              <el-input-number v-model="imageData.begin" :min="0" :max="imageData.end" :step="1"></el-input-number>
            </el-form-item>
            <el-form-item label="结束帧">
              <el-input-number v-model="imageData.end" :min="imageData.begin" :max="9999" :step="1"></el-input-number>
            </el-form-item>
            <el-form-item label="帧间隔">
              <el-input-number v-model="imageData.step" :min="1" :max="60" :step="1"></el-input-number>
            </el-form-item>
            <el-form-item label="描述">
...
const handleConfirmData = async () => {
  try {
    const data = {
      ...editPartVideoData.value,
      startIndex: editPartVideoData.value.start ? translateTime(editPartVideoData.value.start) : 0,
      endIndex: editPartVideoData.value.end ? translateTime(editPartVideoData.value.end) : 0,
    };
