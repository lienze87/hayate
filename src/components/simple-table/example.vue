<template>
  <div class="home-container">
    ...
    <SimpleTable
      :init-data="dataList"
      :columns="dataColumns"
      @selection-change="handleSelectionChange"></SimpleTable>
  </div>
  <div class="home-container">
    ...
    <SimpleTable
      ...
      <template #op="scope">
        <el-button type="primary" @click="handleCustomClick(scope.row)"
          >详情</el-button
        >
      </template>
    </SimpleTable>
      ...
      children: [
        {
          ...
          render: (row: any) =>
            h(
              ...
              {
                class: "red-cell",
                onClick: (e: Event) => console.log(row.studentNo),
              },
              row.collegeName
            ),
        },
